...
save(scenariogrid, file="./simulations/hierpr/results/intermediate_results/scenariogrid_2.Rda")
...
source("./simulations/hierpr/functions_simulation_2.R")
...
save(results, file="./simulations/hierpr/results/intermediate_results/results_2.Rda")  
