...
ggsave("./Simulations/HierPr/Results/figures/hierpr_raw_values.pdf", width=9, height=9)
...
ggsave("./Simulations/HierPr/Results/figures/hierpr_standardized_difference.pdf", width=9, height=9)
# stDiff
...
# pdf("./simulations/hierpr/results/intermediate_results/data200.pdf", width=30)
par(mfrow=c(2,1))
