...
save(scenariogrid, file="./nsrs/results/intermediate_results/scenariogrid.Rda")
...
save(results, file="./nsrs/results/intermediate_results/results.Rda")  
