...
save(scenariogrid, file="./hierpr/results/intermediate_results/scenariogrid_subset_test.Rda")
...
source("./hierpr/functions_simulation_subset_test.R")
...
save(results, file="./hierpr/results/intermediate_results/results_subset_test.Rda")  
