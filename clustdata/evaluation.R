...
# Fig. 2: Simulation on clustered data: cross-validated MSE values for each setting with cluster-specific means
...
# Fig. S1: Simulation on clustered data: cross-validated MSE values of the linear models for each setting without
...
# Fig. S2: Simulation on clustered data: cross-validated MSE values of the linear models for each setting for which
...
# Fig. S3: Simulation on clustered data: cross-validated MSE values of the linear models for each setting for which
...
# Fig. S4: Simulation on clustered data: cross-validated MSE values of the random forests without cluster-constant
# feature values.
...
# Fig. S5: Simulation on clustered data: cross-validated MSE values of the random forests for which the x1 values
...
# Fig. S6: Simulation on clustered data: cross-validated MSE values of the random forests for which the x2 values
# were constant within clusters.
